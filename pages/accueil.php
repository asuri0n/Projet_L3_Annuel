<?php
$exercices = getArrayFrom($pdo, "SELECT id_exercice, id_semestre, ue_num, matieres.libelle as mlib, exercice.enonce as exlib, date FROM exercice JOIN matieres USING (id_matiere)", "fetchAll");
...
foreach ($exercices as $exercice){
    ...
    echo "<td>".$exercice['id_semestre']."</td>";
    echo "<td>".$exercice['mlib']."</td>";
    echo "<td>".$exercice['exlib']."</td>";
    echo "<td><a href='".WEBROOT."exercices/".$exercice['id_exercice']."' class=\"btn btn-default btn-sm ".(($exercice['id_semestre']>2 and !isset($_SESSION['Auth']))?'disabled':"")." \" role=\"button\">
...
<div class="jumbotron">
    ...
    <p style="font-size: small">Projet annuel développé par Lounis Bibi et Nathan Chevalier pendant l'année de L3 Informatique 2017-2018</p>
</div>
